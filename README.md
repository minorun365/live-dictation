...
ウィンドウを閉じてもアプリはメニューバーに残り、会議の検知を続けます。録音中もウィンドウを閉じられます。メニューバーの波形アイコンから、いまの状態の確認、録音の開始と停止、ウィンドウの再表示ができます。終了するときは⌘Qか、メニューバーの「文字起こしちゃんを終了」を選びます。Macを再起動しても検知を続けたい場合は、システム設定の「一般」→「ログイン項目と機能拡張」へ文字起こしちゃんを追加してください。
